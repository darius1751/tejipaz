import { Section, Row, Column, Img, Link, Tailwind, Text, Html, Head, Body, Preview, Container, Heading, Hr } from "@react-email/components";
type Props = {
    name: string;
    token: string;
    url: string;
}
const VerificateEmail = ({ name, token, url }: Props) => {
    return (
        <Html>
            <Head />
            <Tailwind>
